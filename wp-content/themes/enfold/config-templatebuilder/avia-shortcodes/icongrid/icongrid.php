...
//						),
			...
			$c = array(
						array(
							...
							'desc'			=> __( 'Set the padding for the icongrid container. Both pixel and &percnt; based values are accepted. eg: 30px, 5&percnt;. Leave empty to use theme default.', 'avia_framework' ),
							'id'			=> 'icongrid_padding',
							'std'			=> '',
						)
				);
...
//							'no_toggle'		=> true
		...
		protected function get_element_styles( array $args )
		{
			...
			$element_styling->add_responsive_font_sizes( 'li-content', 'size', $atts, $this );
