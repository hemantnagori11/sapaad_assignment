		...
		protected function register_dynamic_templates()
		{
			...
			$c = array(
						array(
							'type'			=> 'template',
							'template_id'	=> 'margin',
							'name'			=> __( 'Slide Margin', 'avia_framework' ),
							'desc'			=> __( 'Set a distance between the slides - need when using box shadow outside. Both pixel and &percnt; based values are accepted. eg: 30px, 5&percnt;. Leave empty for none.', 'avia_framework' ),
							'std'			=> ''
						),
						...
						array(
							...
							'desc'			=> __( 'Set a distance between the content and slide borders. Both pixel and &percnt; based values are accepted. eg: 30px, 5&percnt;. Leave empty for none.', 'avia_framework' ),
							'std'			=> ''
						)
...
if ( ! class_exists( 'avia_content_slider' ) )
{
	class avia_content_slider extends \aviaBuilder\base\aviaSubItemQueryBase
	{
		...
		public function get_element_styles( array $result )
		{
			...
			$element_styling->add_callback_styles( 'slide', array( 'border', 'border_radius', 'box_shadow', 'padding', 'margin' ) );
		...
		public function html()
		{
			...
			$output  = '';
			$output .= $style_tag;
			$output .= "<div {$el_id} {$data} class='{$container_class} avia-content-slider" . avia_content_slider::$slider . "'>";
